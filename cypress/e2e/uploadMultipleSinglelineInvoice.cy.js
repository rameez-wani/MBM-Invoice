describe('Login', () => {
    ...
    it('Upload Multiple invoices!', () => {
        ...
        cy.get('#brows-file-btn').selectFile(['InvoiceWithIssuesInAmount/ML1.pdf', 'InvoiceWithIssuesInAmount/ML2.pdf',], {action: 'drag-drop'}) 
      ...
      //  cy.get('#brows-file-btn').selectFile(['Multiline/Rg 02.12.2022 - fairkehr - 2022-01780.pdf', 'Multiline/Rg 13.12.2022 - Telekom - 7306349416 (1).pdf','Multiline/Rg 31.12.2022 - Endrussat - 37075.pdf'], {action: 'drag-drop'}) 
        ...
        cy.get('.link.common-invoice-ref-91').then(($elements) => {

            Cypress._.each($elements, (el, index) => {

                cy.get('.link.common-invoice-ref-91').eq(index).click();
                cy.wait(8000);
